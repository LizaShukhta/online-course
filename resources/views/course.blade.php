...
<section>
	<div class="container" >
		<div class="row">
			<div class="col-md-9 col-sm-5 wow fadeInDown" >
			<h2 class="lead" >{{$one->name}}</h2>
					<p><img src="{{asset('files/'.$one->picture)}}" class="mypic" /></p>
					<p>{{$one->desc}}</p>
					<p>{{$one->reps}}/{{$one->sets}}</p>
					</br>
					<p></br></p>
			</div>
		</div><!-- Content row end -->
...
@endforeach
@else <p class="lead" align="center"></br>Зарегистрируйтесь для просмотра контента.</p>
@endif
@endsection